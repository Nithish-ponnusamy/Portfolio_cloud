      ...
      <div className="container mx-auto px-4 z-20 relative">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl text-white font-bold mb-8">
            I am <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-500">NITHISH P</span>
          </h2>
          ...
          >
            ...
            <motion.a 
              href="https://www.linkedin.com/in/nithish-p-26738a259/" 
              target="_blank" 
              rel="noopener noreferrer" 
            ...
            <motion.a 
              href="https://instagram.com/nithi._.np" 
              target="_blank" 
              rel="noopener noreferrer" 
