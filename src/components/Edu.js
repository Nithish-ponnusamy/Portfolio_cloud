...
const EducationCertifications = () => {
  const education = [
    {
      ...
      institution: 'Bharani Park Matriculation Higher Secondary School, Karur',
      duration: '2019-2020',
      description: 'Percentage: 60.2%'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      duration: '2022-2026',
      description: 'CGPA: 7 (Upto 5th Semester)'
    }
  ];
  ...
  const certificates = [
    {
      id: 1,
      name: 'Amazon web Services (AWS) Certified cloud Practitioner',
      issuer: 'aws',
      description: 'Completed the AWS Certified Cloud Practitioner certification, demonstrating foundational cloud knowledge and skills.',
      link: 'https://drive.google.com/file/d/1278ykPOxnyXZ7rC-FVM847peqcSmfnSF/view'
    }
  ];
